 ...
 *
 * @extends Pool
 * @see {@link https://github.com/felixge/node-mysql#pooling-connections|Pool}
 */
class PoolPlus extends Pool {
   ...
   *     the `migrationStrategy` value from the {@link mysql-plus~createPool|`config`}
 ...
 * The exact same thing as {@link mysql-plus~Type|`mysql.Type`}.
