...
const ColumnDefinitions = {
  ...
  geometry() {
    return new ColumnDefinition('geometry');
  },
  point() {
    return new ColumnDefinition('point');
  },
  linestring() {
    return new ColumnDefinition('linestring');
  },
  polygon() {
    return new ColumnDefinition('polygon');
  },
  multipoint() {
    return new ColumnDefinition('multipoint');
  },
  multilinestring() {
    return new ColumnDefinition('multilinestring');
  },
  multipolygon() {
    return new ColumnDefinition('multipolygon');
  },
  geometrycollection() {
    return new ColumnDefinition('geometrycollection');
  },
};
